"""Run a worker's LOFT 32K budget matrix with one Qwen model load."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-file", default="evaluate_loft32k_config.yaml")
...
def main() -> None:
    ...
    if not isinstance(config.data_dir, list):
        raise ValueError("LOFT 32K matrix config requires data_dir to be a task list")
