#!/bin/bash
#SBATCH --job-name=synthetickv-64k-qwen25-1m
...
"${BASE_DIR}/miniconda3/envs/kvpress/bin/python" run_matrix.py \
  --config-file benchmarks/synthetic_kv/slurm/evaluate_synthetic_kv_64k_qwen25_1m_baseline.yaml \
  --profile synthetic-kv-64k-qwen25-1m-baseline
