...
DATASETS = {
    "32k": "ollamaweights/synthetickv_32l",
    "64k": "ollamaweights/synthetickv_formated",
}
...
def validate_dataset(dataset: Any, dataset_id: str, variant: str) -> None:
    ...
    if "Records:" not in row["context"]:
        raise RuntimeError("Dataset context is missing the 'Records:' boundary")
