"""Run a worker's RULER 32K reference tasks with one Qwen model load."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config-file", default="evaluate_ruler32k_baseline_config.yaml")
...
def main() -> None:
    ...
    if not isinstance(config.data_dir, list):
        raise ValueError("RULER 32K baseline config requires data_dir to be a task list")
